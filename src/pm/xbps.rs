...
impl Pm for Xbps {
    ...
    async fn r(&self, kws: &[&str], flags: &[&str]) -> Result<()> {
        self.run_with(
            Cmd::with_sudo(["xbps-remove"]).kws(kws).flags(flags),
            self.default_mode(),
            &STRAT_PROMPT,
        )
        .await
    ...
    async fn rs(&self, kws: &[&str], flags: &[&str]) -> Result<()> {
        self.run_with(
            Cmd::with_sudo(["xbps-remove", "-R"]).kws(kws).flags(flags),
            self.default_mode(),
            &STRAT_PROMPT,
        )
        .await
    ...
    async fn s(&self, kws: &[&str], flags: &[&str]) -> Result<()> {
        self.run_with(
            Cmd::with_sudo(["xbps-install"]).kws(kws).flags(flags),
            self.default_mode(),
            &STRAT_PROMPT,
        )
        .await
    ...
    async fn sc(&self, kws: &[&str], flags: &[&str]) -> Result<()> {
        self.run_with(
            Cmd::with_sudo(["xbps-remove", "-O"]).kws(kws).flags(flags),
            self.default_mode(),
            &STRAT_PROMPT,
        )
        .await
    ...
    async fn sw(&self, kws: &[&str], flags: &[&str]) -> Result<()> {
        self.run_with(
            Cmd::with_sudo(["xbps-install", "-D"]).kws(kws).flags(flags),
            self.default_mode(),
            &STRAT_PROMPT,
        )
        .await
    ...
    async fn su(&self, kws: &[&str], flags: &[&str]) -> Result<()> {
        self.run_with(
            Cmd::with_sudo(["xbps-install", "-u"]).kws(kws).flags(flags),
            self.default_mode(),
            &STRAT_PROMPT,
        )
        .await
